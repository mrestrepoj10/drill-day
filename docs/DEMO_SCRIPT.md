...
The same happens with no drill loaded at all: paste the shift-handover prompt from the start screen and the agent walks the building in first person while it briefs you.
