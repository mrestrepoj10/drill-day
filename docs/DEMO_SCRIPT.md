...
Show the launch screen, generated incident brief, three stages, Scene API badge, and 13-site-tool badge. Start the flagship drill.
...
Walk far enough to show the route and room signs. Open the agent activity panel if necessary.
...
Show a hint marker, select the leak, then choose the Room 214 terminal valve as a near miss. Select the first-floor chilled-water isolation as the correct answer.
