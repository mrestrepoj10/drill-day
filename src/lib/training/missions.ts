  ...
  technician: {
    ...
    steps: [
      ...
      },
      {
        id: "t2",
        mode: "select",
        prompt: "Look above the missing ceiling tile. Aim at a component to have it named, then select the source of the leak.",
      ...
      },
      {
        ...
        guidance:
          "The valve is not in Room 214. Leave the room and cross the corridor to the Level 1 riser cupboard, then aim at each of the paired valves to tell chilled water from heating.",
